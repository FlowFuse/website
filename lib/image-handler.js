...
module.exports = function imageHandler(
    ...
    const eleventyInputFolderPath = eleventyConfig.directories?.input || eleventyConfig.dir.input
    const eleventyOutputFolderPath = eleventyConfig.directories?.output || eleventyConfig.dir.output
