...
const NUXT_PREFIXES = ['/handbook', '/ebooks', '/whitepaper', '/pricing', '/docs', '/changelog', '/application-guide', '/blog', '/product', '/customer-stories', '/thank-you', '/resources', '/webinars', '/use-cases', '/industries', '/platform', '/vs', '/partners', '/events', '/landing', '/free-consultation', '/community', '/careers']
...
// / (homepage), /about, /blueprints, /node-red
