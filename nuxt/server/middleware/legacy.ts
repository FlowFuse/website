...
// '/platform/hmi' is a single route rather than a '/platform' prefix: the rest of
// /platform/** is still 11ty (.njk), and a prefix here would 404 all of it in dev.
const NUXT_ROUTES = new Set(['/ai', '/terms', '/privacy-policy', '/integrations', '/resources/publications', '/sitemap.xml', '/robots.txt', '/llms.txt', '/llms-full.txt', '/contact-us', '/book-demo', '/support', '/professional-services', '/dashboard/tags-and-canvas-feedback', '/platform/hmi'])
