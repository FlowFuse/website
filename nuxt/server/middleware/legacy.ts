...
const NUXT_ROUTES = new Set(['/', '/about', '/ai', '/platform', '/terms', '/privacy-policy', '/integrations', '/sitemap.xml', '/robots.txt', '/llms.txt', '/llms-full.txt', '/contact-us', '/book-demo', '/support', '/professional-services', '/dashboard/tags-and-canvas-feedback'])
...
// /platform/{dashboard,device-agent,security,why-flowfuse}, /use-cases, /webinars
