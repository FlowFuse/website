...
const NUXT_ROUTES = new Set(['/', '/ai', '/terms', '/privacy-policy', '/integrations', '/sitemap.xml', '/robots.txt', '/llms.txt', '/llms-full.txt', '/contact-us', '/book-demo', '/support', '/professional-services', '/dashboard/tags-and-canvas-feedback', '/use-cases/edge-connectivity'])
...
// /use-cases (except /use-cases/edge-connectivity, migrated), /webinars
