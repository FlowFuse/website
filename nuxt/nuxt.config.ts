...
export default defineNuxtConfig({
    ...
    nitro: {
        preset: 'static',
        prerender: {
            routes: ['/terms', '/privacy-policy', '/solutions/scada', '/solutions/uns', '/solutions/edge-connectivity', '/solutions/data-integration', '/solutions/mes', '/solutions/it-ot-middleware', '/vs/kepware', '/vs/litmus', '/whitepaper/accelerating-innovation-in-manufacturing-with-flowfuse', '/whitepaper/open-source-software-for-manufacturing', '/whitepaper/uns-decoupling-data-producers-and-consumers', '/jobs/developer-relations-advocate', '/jobs/engineering-manager', '/jobs/solutions-engineer', ...handbookRoutes, ...changelogRoutes, ...customerStoriesRoutes, ...eventRoutes, ...ebookRoutes],
            crawlLinks: false
        }
    },
