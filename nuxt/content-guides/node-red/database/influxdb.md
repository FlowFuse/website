...
<a href="https://app.flowfuse.com/account/create"
   class="mb-4 block"
   onclick="capture('blog-cta', { reference: 'Node-RED: Using InfluxDB with Node-RED', position: 'inline-image', cta_type: 'sign-up' })">
  <img src="/docs/node-red/database/images/influxdb-node-red-cta-1.png" alt="Write to InfluxDB from every Node-RED instance you run, all from one place" loading="lazy">
</a>
...
<video autoplay loop muted playsinline aria-label="Checking the data has arrived in InfluxDB" width="904" height="654" preload="none"><source src="/docs/node-red/database/images/data_in_influx.webm" type="video/webm" /></video>
