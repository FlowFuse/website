...
<video autoplay loop muted playsinline aria-label="Video showing LwM2M Server reading the device details" width="1908" height="838" preload="none"><source src="/docs/node-red/protocol/images/lwm2m-server-reading.webm" type="video/webm" /></video>
...
<video autoplay loop muted playsinline aria-label="Video showing how to perform write operation in the LwM2M server" width="1908" height="838" preload="none"><source src="/docs/node-red/protocol/images/writing-in-server.webm" type="video/webm" /></video>
...
<video autoplay loop muted playsinline aria-label="Video showing the LwM2M server executing reboot command for device" width="1908" height="772" preload="none"><source src="/docs/node-red/protocol/images/executing-command-from-server.webm" type="video/webm" /></video>
...
<video autoplay loop muted playsinline aria-label="Video showing Node-RED flow that reading data from LwM2M Server" width="1908" height="830" preload="none"><source src="/docs/node-red/protocol/images/reading-data-from-server-in-nr.webm" type="video/webm" /></video>
...
<video autoplay loop muted playsinline aria-label="Video showing Node-RED flow that writing data to LwM2M Server" width="1908" height="832" preload="none"><source src="/docs/node-red/protocol/images/writing-data-to-server-from-nr.webm" type="video/webm" /></video>
