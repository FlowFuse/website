...
<a href="https://app.flowfuse.com/account/create"
   class="mb-4 block"
   onclick="capture('blog-cta', { reference: 'Node-RED: How to Update Node-RED', position: 'inline-image', cta_type: 'sign-up' })">
  <img src="/docs/node-red/getting-started/images/update-node-red-cta-1.png" alt="Update hundreds of Node-RED instances in one click, not one at a time" loading="lazy">
</a>
