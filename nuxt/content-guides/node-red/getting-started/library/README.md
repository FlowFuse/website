...
<video autoplay loop muted playsinline aria-label="Installing a Node-RED node through the Palette Manager in the Node-RED editor" width="1326" height="720" preload="none"><source src="/docs/node-red/getting-started/library/images/installing-node-red-node.webm" type="video/webm" /></video>
