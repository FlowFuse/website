...
<video autoplay loop muted playsinline aria-label="Video showing navigator tool" width="800" height="489" preload="none"><source src="/docs/node-red/getting-started/editor/images/workspace-navigator-tool.webm" type="video/webm" /></video>
...
<video autoplay loop muted playsinline aria-label="Video showing how to reorder flows in the editor" width="800" height="151" preload="none"><source src="/docs/node-red/getting-started/editor/images/workspace-reordering-flow.webm" type="video/webm" /></video>
...
<video autoplay loop muted playsinline aria-label="Video showing 'How to edit the subflow properties'" width="800" height="450" preload="none"><source src="/docs/node-red/getting-started/editor/images/subflow-editing-properties.webm" type="video/webm" /></video>
...
<video autoplay loop muted playsinline aria-label="Video showing how to convert nodes into the subflow" width="800" height="450" preload="none"><source src="/docs/node-red/getting-started/editor/images/subflow-converting-nodes-to-subflow.webm" type="video/webm" /></video>
...
![Image showing the node status](./images/mqtt-in-node-status.png "Image showing the node status"){data-zoomable}
...
<video autoplay loop muted playsinline aria-label="Video showing how to add nodes quickly using quick-add dialog" width="471" height="313" preload="none"><source src="/docs/node-red/getting-started/editor/images/node-quick-add-dialog.webm" type="video/webm" /></video>
...
<video autoplay loop muted playsinline aria-label="Video showing how to wire node's together" width="554" height="159" preload="none"><source src="/docs/node-red/getting-started/editor/images/wiring-nodes-together.webm" type="video/webm" /></video>
...
<video autoplay loop muted playsinline aria-label="Video showing how to delete the wires" width="516" height="112" preload="none"><source src="/docs/node-red/getting-started/editor/images/deleting-wires.webm" type="video/webm" /></video>
...
<video autoplay loop muted playsinline aria-label="Video showing how to move a single wire" width="626" height="207" preload="none"><source src="/docs/node-red/getting-started/editor/images/moving-wire.webm" type="video/webm" /></video>
...
<video autoplay loop muted playsinline aria-label="Video showing how to move multiple wires" width="635" height="249" preload="none"><source src="/docs/node-red/getting-started/editor/images/moving-multiple-wires.webm" type="video/webm" /></video>
...
<video autoplay loop muted playsinline aria-label="Video showing how to slice wires quickly" width="689" height="173" preload="none"><source src="/docs/node-red/getting-started/editor/images/slicing-wires.webm" type="video/webm" /></video>
...
<video autoplay loop muted playsinline aria-label="Video showing how to delete nodes while keeping wires" width="710" height="169" preload="none"><source src="/docs/node-red/getting-started/editor/images/removing-nodes-while-keeping-wires.webm" type="video/webm" /></video>
...
<video autoplay loop muted playsinline aria-label="Video showing how to detach nodes while keeping wires" width="664" height="168" preload="none"><source src="/docs/node-red/getting-started/editor/images/detaching-nodes-while-keeping-wires.webm" type="video/webm" /></video>
...
<video autoplay loop muted playsinline aria-label="Video showing how to create the group" width="800" height="450" preload="none"><source src="/docs/node-red/getting-started/editor/images/creating-group.webm" type="video/webm" /></video>
...
<video autoplay loop muted playsinline aria-label="Video showing how to add nodes to existing group" width="750" height="302" preload="none"><source src="/docs/node-red/getting-started/editor/images/adding-nodes-to-group.webm" type="video/webm" /></video>
...
<video autoplay loop muted playsinline aria-label="Video showing how to remove nodes from existing group" width="681" height="259" preload="none"><source src="/docs/node-red/getting-started/editor/images/removing-node-from-group.webm" type="video/webm" /></video>
...
<video autoplay loop muted playsinline aria-label="Video showing how to merge multple groups into single group" width="800" height="450" preload="none"><source src="/docs/node-red/getting-started/editor/images/group-merging-groups.webm" type="video/webm" /></video>
...
<video autoplay loop muted playsinline aria-label="Video showing how to ungroup selected nodes" width="800" height="317" preload="none"><source src="/docs/node-red/getting-started/editor/images/removing-nodes-from-group.webm" type="video/webm" /></video>
...
<video autoplay loop muted playsinline aria-label="Video showing the lasso tool selection" width="497" height="288" preload="none"><source src="/docs/node-red/getting-started/editor/images/lasso-tool.webm" type="video/webm" /></video>
...
<video autoplay loop muted playsinline aria-label="Video showing how to select connected nodes" width="625" height="189" preload="none"><source src="/docs/node-red/getting-started/editor/images/selecting-connected-nodes.webm" type="video/webm" /></video>
...
<video autoplay loop muted playsinline aria-label="Video showing how to select upstream connected nodes" width="648" height="184" preload="none"><source src="/docs/node-red/getting-started/editor/images/selecting-upward-connected-nodes.webm" type="video/webm" /></video>
...
<video autoplay loop muted playsinline aria-label="Video showing how to select downstream connected nodes" width="590" height="148" preload="none"><source src="/docs/node-red/getting-started/editor/images/selecting-downward-connected-nodes.webm" type="video/webm" /></video>
...
<video autoplay loop muted playsinline aria-label="Video showing how to select multiple flows at a time" width="800" height="135" preload="none"><source src="/docs/node-red/getting-started/editor/images/selecting-flows.webm" type="video/webm" /></video>
