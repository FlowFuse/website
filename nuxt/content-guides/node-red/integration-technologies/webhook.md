...
<video autoplay loop muted playsinline aria-label="Video displaying the flow of scheduled maintenance table" width="600" height="338" preload="none"><source src="/docs/node-red/integration-technologies/images/using-webhook-with-node-red-scheduled-maintenance-table-dashboard-view.webm" type="video/webm" /></video>
