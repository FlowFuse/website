...
metaTitle: "Node-RED - Unknown Node"
navTitle: "Unknown"
navOrder: 8
---
...
![List of nodes installed, including unused nodes](/docs/node-red/core-nodes/images/list-nodes-unused.png)
...
<video autoplay loop muted playsinline aria-label="List of nodes installed through the System Info dialog" width="1484" height="868" preload="none"><source src="/docs/node-red/core-nodes/images/system-info-installed-nodes.webm" type="video/webm" /></video>
...
::node-red-help{category="common" file="98-unknown" node="unknown" name="Unknown"}
::
