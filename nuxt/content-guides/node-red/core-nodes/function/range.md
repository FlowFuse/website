...
![Range properties](/docs/node-red/core-nodes/images/range-node2.png)
...
::node-red-help{category="function" file="16-range" node="range" name="Range"}
::
