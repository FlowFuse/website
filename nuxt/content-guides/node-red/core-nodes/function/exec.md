...
!["Wired up exec node"](/docs/node-red/core-nodes/images/wired-up-exec-node.png)
...
![spawn mode for exec in Node-RED](/docs/node-red/core-nodes/images/spawn-mode-exec.png)
...
::node-red-help{category="function" file="90-exec" node="exec" name="Exec"}
::
