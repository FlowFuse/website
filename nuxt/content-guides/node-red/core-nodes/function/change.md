...
metaTitle: "Node-RED - Change Node"
navTitle: "Change"
navOrder: 3
---
...
![Data Transform](/docs/node-red/core-nodes/images/change-data-transform.png)
...
![Message Filter](/docs/node-red/core-nodes/images/change-message-filter.png)
::render-flow
```json
...
![Message Enrichment](/docs/node-red/core-nodes/images/change-message-enrich.png)
::render-flow
```json
...
![Example](/docs/node-red/core-nodes/images/change-rename-property.png)
::render-flow
```json
...
![Example](/docs/node-red/core-nodes/images/change-default.png)
::render-flow
```json
...
![Example](/docs/node-red/core-nodes/images/change-message-format.png)
::render-flow
```json
...
::node-red-help{category="function" file="15-change" node="change" name="Change"}
::
