...
![Delay node properties](/docs/node-red/core-nodes/images/delay-node-2.png)
...
::node-red-help{category="function" file="89-delay" node="delay" name="Delay"}
::
