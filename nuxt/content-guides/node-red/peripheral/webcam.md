...
<video autoplay loop muted playsinline aria-label="capturing images using webcam widget controls" width="442" height="450" preload="none"><source src="/docs/node-red/peripheral/images/using_webcam_with_node-red_capturing_images_by_control.webm" type="video/webm" /></video>
...
<video autoplay loop muted playsinline aria-label="capturing images by passing payload" width="600" height="291" preload="none"><source src="/docs/node-red/peripheral/images/using_webcam_with_node-red_capturing_images_by_passing_payload.webm" type="video/webm" /></video>
...
<video autoplay loop muted playsinline aria-label="selecting different camera" width="600" height="606" preload="none"><source src="/docs/node-red/peripheral/images/using_webcam_with_node-red_selecting_different_camera.webm" type="video/webm" /></video>
