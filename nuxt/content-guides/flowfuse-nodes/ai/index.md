...
- [ONNX](/docs/flowfuse-nodes/ai/onnx/): The ONNX node allows you to perform AI inference directly in Node-RED using ONNX models, supporting image, object, and numeric predictions without external AI services.
