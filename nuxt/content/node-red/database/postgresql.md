...
!["Configuring PostgreSQL Connection"](/node-red-media/database/images/postgresql_with_node-red_pgconfig1.png "Configuring PostgreSQL Connection")

!["Configuring PostgreSQL Security"](/node-red-media/database/images/postgresql_with_node-red_pgconfig2.png "Configuring PostgreSQL Security")
...
!["Adding environment variables"](/node-red-media/database/images/postgresql_with_nodred_environment_variable.png "Adding environment variables")
...
```
!["Creating table for product data"](/node-red-media/database/images/postgresql_with_nodered_create_table.png "Creating table for product data")
...
!["Adding form to insert data"](/node-red-media/database/images/postgresql_with_node-red_form1.png "Adding form to insert data")
...
VALUES ($1, $2, $3);
```
!["Inserting data into database"](/node-red-media/database/images/postgresql_with_node-red_insert_data.png "Inserting data into database")
...
```
!["Retriving all product data from database"](/node-red-media/database/images/postgresql_with_node-red_retrive_data.png "Retriving all product data from database")

## Updating product data to the Database
!["Adding form to update product data"](/node-red-media/database/images/postgresql_with_node-red_form2.png "adding form to update product data")
...
!["Updating product data to the database"](/node-red-media/database/images/postgresql_with_node-red_update_data.png "Updating product data to the database")

5. Connect ui-form’s output to the function node’s input and the function node's output to the PostgreSQL node’s input.

## Deleting product data from the database

!["Deleting product data to the database"](/node-red-media/database/images/postgresql_with_node-red_form3.png "Deleting product data to the database")
...
```
!["Deleting product data to the database"](/node-red-media/database/images/postgresql_with_node-red_delete_data.png "Deleting product data to the database")
...
!["Droping product_data from the database"](/node-red-media/database/images/postgresql_with_node-red_drop_tables.png "Droping product_data from the database")

## Deploying Flow
!["Deploying Inventory management system's flow"](/node-red-media/database/images/postgresql_with_nodred_environment_variable_ff_editor.png "Deploying Inventory management system's flow")
...
!["Inventory management system"](/node-red-media/database/images/postgresql_with_node-red_Inventory_management_system.png "Inventory management system")
