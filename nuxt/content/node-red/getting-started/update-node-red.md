...
![FlowFuse Node-RED instance update interface](/node-red-media/getting-started/images/node-red-instance-update.png){data-zoomable}
...
![FlowFuse scheduled update configuration](/node-red-media/getting-started/images/schedule-update.png){data-zoomable}
