...
![Status of the remote instance in FlowFuse, showing its connection and operational state](/node-red-media/hardware/images/raspberry-pi-4.png "Status of the remote instance in FlowFuse, showing its connection and operational state"){data-zoomable}
