...
![Configuring an MQTT broker in Node-RED](/node-red-media/protocol/images/mqtt-broker-config.png)
...
![MQTT Out node — publishing data to a topic](/node-red-media/protocol/images/mqtt-out.png)
...
![Connected MQTT node showing green status](/node-red-media/protocol/images/connected-mqtt-node.png)
...
![MQTT In node — subscribing to a topic](/node-red-media/protocol/images/mqtt-in-config.png)
