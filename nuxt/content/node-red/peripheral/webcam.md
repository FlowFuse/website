...
!["capturing images using webcam widget controls"](/node-red-media/peripheral/images/using_webcam_with_node-red_capturing_images_by_control.gif "capturing images using webcam widget controls")
...
!["capturing images by passing payload"](/node-red-media/peripheral/images/using_webcam_with_node-red_capturing_images_by_passing_payload.gif "capturing images by passing payload")
...
!["selecting different camera"](/node-red-media/peripheral/images/using_webcam_with_node-red_selecting_different_camera.gif "selecting different camera")
