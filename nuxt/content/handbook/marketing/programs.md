...
include the following 5 components that will complete using [this GitHub issue template](https://github.com/FlowFuse/marketing/issues/new?template=06-marketing-campaign.yaml):
