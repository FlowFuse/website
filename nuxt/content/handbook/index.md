...
The handbook can be edited by anyone at FlowFuse using **Nuxt Studio**, our CMS. Click **"Sign in to edit"** on any handbook page to sign in with GitHub. Studio then loads on every handbook page, and its control in the bottom-left corner opens the editor. Make your changes there and submit them for review. No Git knowledge required.
