...
You do not record the release number here. It goes in the post's own `release` frontmatter field, described above.

Always write an availability note in the post. Nothing else states the tier for the reader, so prose has to. Write it like this:
