...
![Selecting the PostHog environment in the top-left corner](../images/confirm-env-posthog.png){data-zoomable width="390px"}
...
![Configuring the release condition set to target teams at 100%](../images/rollout-percentage-posthog.png){data-zoomable width="701px"}

6. Click **Save**. Your condition set should now look like this:

![The saved condition set targeting 100% of teams](../images/condition-set-posthog.png){data-zoomable width="746px"}
...
![The Feature Flags overview showing the release condition at 100% of all teams](../images/confirm-change-posthog.png){data-zoomable}
