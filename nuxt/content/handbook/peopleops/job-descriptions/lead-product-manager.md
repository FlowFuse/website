...
This role builds on the [Product Manager](https://flowfuse.com/handbook/peopleops/job-descriptions/product-manager/) role. Where the base role defines product strategy across FlowFuse, the Lead Product Manager applies that craft with full ownership of a single area, working hands-on and directly with engineers.
...
The base [Product Manager](https://flowfuse.com/handbook/peopleops/job-descriptions/product-manager/) exclusions apply, with the following clarifications:
