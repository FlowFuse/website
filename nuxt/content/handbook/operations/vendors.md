...
When selecting a new vendor, ensure that the choice is made deliberately to address the specific and immediate needs of each department. Open an issue in the [flowfuse/admin](https://github.com/FlowFuse/admin) repository describing the vendor, the need it addresses, and the associated costs, and assign it to the CEO or CTO. Conduct appropriate interviews and record them using Fathom to share with relevant stakeholders and interested parties involved in the decision-making process. Review the contract and budget and share your thoughts and opinion with the CEO in the issue. The final vendor selection will be approved by the CEO or CTO in the issue, and the engagement should not beging until that approval is given.
