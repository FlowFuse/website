...
navTitle: FlowFuse 0.8 released
---
...
!["Screenshot showing the message being sent from one project to another using project link nodes"](/blog/2022/08/images/ProjectLink.gif "Screenshot showing the message being sent from one project to another using project link nodes")
...
[FlowFuse Cloud](https://app.flowfuse.com) is already running 0.8 and the stacks updated. Upgrade your project stacks to the latest version and start using the Project Link nodes now.
