...
navTitle: Create HTTP triggers with authentication
---
...
![Shows the UI to edit the node's properties](/blog/2022/12/images/edit-http-node.png "Shows the UI to edit the node's properties")
