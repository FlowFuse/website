...
navTitle: Configure FlowFuse in Docker to secure all traffic
---
...
![A screenshot from Safari web browser showing that the traffic to FlowFuse is encrypted](/blog/2022/12/images/https-working.png "A screenshot from Safari web browser showing that the traffic to FlowFuse is encrypted")
