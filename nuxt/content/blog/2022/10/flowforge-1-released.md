...
navTitle: FlowFuse 1.0 released
---
...
Our managed [FlowFuse](https://app.flowfuse.com) is already running 1.0. Upgrade your project Stacks to the latest version to make sure you get all the latest changes.
