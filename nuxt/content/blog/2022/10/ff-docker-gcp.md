...
navTitle: Install FlowFuse Docker on Google Cloud
---
...
!["Screenshot showing the interface for creating GCP VM"](/blog/2022/10/images/1.png "Screenshot showing the interface for creating GCP VM")
...
!["Screenshot showing the firewall section in the interface for creating a GCP VM"](/blog/2022/10/images/2.png "Screenshot showing the firewall section in the interface for creating a GCP VM")
...
!["Screenshot showing the network section in the interface for creating a GCP VM"](/blog/2022/10/images/3.png "Screenshot showing the network section in the interface for creating a GCP VM")
...
!["Screenshot showing your reserved IP in the External IPv4 address field"](/blog/2022/10/images/4.png "Screenshot showing your reserved IP in the External IPv4 address field")
...
![Screenshot showing interface for setting DNS](/blog/2022/10/images/5.png "Screenshot showing interface for setting DNS")
...
![Screenshot showing output of the dig command](/blog/2022/10/images/6.png "Screenshot showing output of the dig command")
...
![Screenshot showing access to SSH in GCP](/blog/2022/10/images/7.png "Screenshot showing access to SSH in GCP")
...
!["Screenshot showing directory listing for FlowFuse"](/blog/2022/10/images/8.png "Screenshot showing directory listing for FlowFuse")
...
!["Screenshot showing domain configuration in flowforge.yml"](/blog/2022/10/images/9.png "Screenshot showing domain configuration in flowforge.yml")
...
!["Screenshot showing email configuration in flowforge.yml"](/blog/2022/10/images/10.png "Screenshot showing email configuration in flowforge.yml")

Finally, you need to update the `public_url` for your mqtt broker to match your DNS record.

!["Screenshot showing MQTT configuration in flowforge.yml"](/blog/2022/10/images/11.png "Screenshot showing MQTT configuration in flowforge.yml")
...
!["Screenshot showing virtual hosts configuration in docker-compose.yml"](/blog/2022/10/images/12.png "Screenshot showing virtual hosts configuration in docker-compose.yml")
...
![Docker PS output](/blog/2022/10/images/13.png)
...
![FF Login page](/blog/2022/10/images/14.png)
