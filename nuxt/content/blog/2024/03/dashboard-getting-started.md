...
navTitle: Getting Started with Node-RED Dashboard 2.0
---
...
![Screenshot to show where to find the "Manage Palette" option in Node-RED](/blog/2024/03/images/dashboard-getting-started-manage-palette.png){data-zoomable}
...
![Screenshot to show where to find the "Install" tab, and how to find @flowfuse/node-red-dashboard](/blog/2024/03/images/dashboard-getting-started-search-install.png){data-zoomable}
...
![Screen recording to show how easy it is to deploy your first Dashboard 2.0 application.](/blog/2024/03/images/dashboard-getting-started-add-widget.gif){data-zoomable}
...
![Screenshot showing the Dashboard 2.0 sidebar in the Node-RED Editor.](/blog/2024/03/images/dashboard-getting-started-sidebar.png){data-zoomable}
...
![Example of a "Grid" page layout, with "Collapsing" sidebar navigation.](/blog/2024/03/images/dashboard-getting-started-layout.png){data-zoomable}
...
![Example of the "Notebook" layout and "Collapse to icons" sidebar](/blog/2024/03/images/dashboard-getting-started-example.png){data-zoomable}
...
![Screenshot of the Node-RED Editor, showing the ui-slider and ui-button connected to our ui-chart](/blog/2024/03/images/dashboard-getting-started-flow.png){data-zoomable}
...
![Screenshot of the Dashboard with all three widgets rendered](/blog/2024/03/images/dashboard-getting-started-final.png){data-zoomable}
...
![The ui-button configuration after setting it's payload and label](/blog/2024/03/images/dashboard-getting-started-btn-config.png){data-zoomable}
...
![Short animation showing the final functional dashboard](/blog/2024/03/images/dashboard-getting-started-final.gif){data-zoomable}
