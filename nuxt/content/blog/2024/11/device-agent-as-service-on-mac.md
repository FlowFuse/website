...
navTitle: Run FlowFuse Device Agent as a service on MacOS using Docker
---
...
![CLI: Showing the result of `colima status`](/blog/2024/11/images/colima-status.png){data-zoomable}
...
![CLI: Showing the result of `docker ps` indicating device agent is running correctly](/blog/2024/11/images/docker-ps-result.png){data-zoomable}
...
![FlowFuse Platform: showing the status of your edge device](/blog/2024/11/images/device-status-on-ff.png){data-zoomable}
