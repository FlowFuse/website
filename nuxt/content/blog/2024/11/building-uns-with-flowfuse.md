...
navTitle: Building a Unified Namespace (UNS) with FlowFuse
---
...
![Function node: Transforming Raw Data into Readable Format](/blog/2024/11/images/function-node.png){data-zoomable}
...
![Change node: Calculating Magnitude](/blog/2024/11/images/change-node-calculating-magnitude.png){data-zoomable}
...
![Change Node: Formatting and structuring payload for UNS](/blog/2024/11/images/change-node-structering-data.png){data-zoomable}
...
![FlowFuse Interface for creating MQTT Client](/blog/2024/11/images/creating-client-interface.png){data-zoomable}
...
![ISA-95 : Equipment Hierarchical Model](/blog/2024/11/images/isa-95-equipement-model.png){data-zoomable}
...
![Configuring mqtt-broker-config node](/blog/2024/11/images/mqtt-broker-node-config.png){data-zoomable}
...
![Configuring mqtt-out node](/blog/2024/11/images/mqtt-out-node-config.png){data-zoomable}
...
![Monitoring your mqtt topic hierarchy within FlowFuse](/blog/2024/11/images/topic-hierarchy.png){data-zoomable}
...
![FlowFuse Dashboard Monitoring Vibrations](/blog/2024/11/images/flowfuse-dashboard.png){data-zoomable}
