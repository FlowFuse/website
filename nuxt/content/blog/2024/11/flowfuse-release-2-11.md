...
navTitle: 'FlowFuse 2.11: MQTT Topic Hierarchy, UI Revamp & Improved Logging'
---
...
![Screenshot of the new navigation sidebar in FlowFuse](/blog/2024/11/images/screenshot-sidebar.png){data-zoomable}
...
![Screenshot of the team-wide search](/blog/2024/11/images/screenshot-search.png){data-zoomable}
...
![Screenshot of the UI to explore your MQTT topic hierarchy](/blog/2024/11/images/screenshot-mqtt-hierarchy.png){data-zoomable}
...
![Screenshot of the improved audit log view](/blog/2024/11/images/audit-log-child-events.png){data-zoomable}
...
If you're using [FlowFuse Cloud](https://app.flowfuse.com), then there is nothing you need to do - it's already running 2.10, and you may have already been playing with the new features.
