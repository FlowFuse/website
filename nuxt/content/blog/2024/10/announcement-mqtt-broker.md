...
navTitle: MQTT Service Now Available on FlowFuse
---
...
![Screenshot of FlowFuse's "Create Client" interface](/blog/2024/10/images/mqtt-broker-add-client.png){data-zoomable}
...
![Screenshot of the MQTT Config, "Connection" tab in the Node-RED Editor](/blog/2024/10/images/mqtt-broker-config.png){data-zoomable}{width=400}
_Screenshot of the MQTT Config, "Connection" tab in the Node-RED Editor_

And the respective "Security" tab:

![Screenshot of the MQTT Config, "Security" tab in the Node-RED Editor](/blog/2024/10/images/mqtt-broker-security.png){data-zoomable}{width=440}
...
![Simplified example of MQTT data flow for a Factory Floor](/blog/2024/10/images/mqtt-factory-architecture.jpg){data-zoomable}
