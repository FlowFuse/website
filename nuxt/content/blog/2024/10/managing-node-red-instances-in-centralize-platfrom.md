...
FlowFuse also simplifies the [monitoring and controlling of edge devices](/use-cases/remote-device-management/) through the [FlowFuse Device Agent](/platform/device-agent/), which quickly connects your devices to the cloud platform and allows you to build and monitor applications remotely.
