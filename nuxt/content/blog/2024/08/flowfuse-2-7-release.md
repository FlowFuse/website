...
navTitle: 'FlowFuse 2.7: Improved management at scale & AI JSON Editor'
---
...
![(Left) Screenshot of the AI prompt for a list of 4-legged creatures and (Right) the resulting JSON generated by the FlowFuse Expert](/blog/2024/08/images/ask-assistant-json.jpg){data-zoomable}
...
![(Left) Screenshot of the AI prompt input for a list of simulated devices and (Right) the resulting JSON generated by the FlowFuse Expert](/blog/2024/08/images/ask-assistant-json-2.png){data-zoomable}
...
If you're using [FlowFuse Cloud](https://app.flowfuse.com), then there is nothing you need to do - it's already running 2.7, and you may have already been playing with the new features.
