...
navTitle: 'Building on FlowFuse: Remote Device Monitoring'
---
...
![Diagram showing the breakdown of each component that makes up a "Device Monitoring" use case.](/blog/2024/07/images/device-monitoring-use-case.png){data-zoomable}
...
![Diagram showing the architecture of a "Device Monitoring" use case in an automotive plant.](/blog/2024/07/images/device-monitoring-architecture.png){data-zoomable}
...
![Lineup of each of the FlowFuse offerings](/blog/2024/07/images/ff-ecosystem-lineup.png){data-zoomable}
