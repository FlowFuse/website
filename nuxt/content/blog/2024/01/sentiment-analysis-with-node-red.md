...
navTitle: Sentiment Analysis with Node-RED
---
...
!["Taking user input for Sentiment analysis using form"](/blog/2024/01/images/sentiment-analysis-form.png "Taking user input for Sentiment analysis using form")
...
!["Normalizing the payload using change node"](/blog/2024/01/images/sentiment-anlaysis-change-node(1).png "Normalizing the payload using change node")
...
!["Calculating the percentage based on the score using the change node"](/blog/2024/01/images/sentiment-analysis-change-node(2).png "Calculating the percentage based on the score using the change node")
...
!["Node-RED flow to do sentiment analysis"](/blog/2024/01/images/sentiment-anlaysis-flow.png "Node-RED flow to do sentiment analysis")

## Deploying the Flow

!["Deploying Sentiment analysis Node-RED flow"](/blog/2024/01/images/sentiement-analysis-flowfuse-editor.png "Deploying Sentiment analysis Node-RED flow")
...
!["Sentiment analysis on Text using Node-RED Dashboard 2.0"](/blog/2024/01/images/sentiment-analysis-dashboard-gif.gif "Sentiment analysis on Text using Node-RED Dashboard 2.0")
