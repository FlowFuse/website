...
navTitle: Node-RED Dashboard 2.0 is Generally Available!
---
...
![Dashboard 2.0 Example showing weather data](/blog/2024/01/images/dashboard-ga-example.png)
...
Furthermore, the most requested feature for the legacy dashboard has been implemented in Dashboard 2.0, the ability to hide charts and forms based on the user that's viewing the dashboard.

![Dashboard 2.0 Example showing personalised dashboard](/blog/2024/01/images/multi-user-dashboard-user2.png)
