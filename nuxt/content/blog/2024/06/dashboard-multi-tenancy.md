...
navTitle: Multi-Tenancy available for everyone with FlowFuse's Dashboard 2.0
---
...
![Screenshot showing the new "Client Data" sidebar available with Dashboard](/blog/2024/06/images/dashboard-multi-tenancy-sidebar.png){data-zoomable}
...
![Example flow diagram to show the flow of data in a "Single Source of Truth" architecture](/blog/2024/06/images/design-pattern-single.png){data-zoomable}
...
![Example flow diagram to show the flow of data in a "Multi-Tenancy" architecture](/blog/2024/06/images/design-pattern-client.png){data-zoomable}
...
![Screenshot showing "FlowFuse User" being appended to `_client` by the FlowFuse User Addon](/blog/2024/06/images/dashboard-include-client-data.png){data-zoomable}
...
![Screenshot of the Instance settings in FlowFuse to enable "FlowFuse User Authentication"](/blog/2024/06/images/flowfuse-instance-security.png){data-zoomable}
