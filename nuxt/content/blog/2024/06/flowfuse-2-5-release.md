...
navTitle: 'FlowFuse 2.5: New features to visualize snapshots, LDAP integration, and more'
---
...
We also regularly release updates to [FlowFuse Cloud](https://app.flowfuse.com) in between our monthly releases. You can follow the updates as they are made via our [ChangeLog](/changelog).
...
[FlowFuse Cloud](https://app.flowfuse.com) is already running 2.5.
