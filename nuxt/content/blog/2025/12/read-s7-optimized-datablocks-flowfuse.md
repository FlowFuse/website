...
navTitle: How to Access Optimized Data Blocks in TIA Portal (S7-1200/1500)
---
...
![Activate OPC UA server option in TIA Portal](/blog/2025/12/images/enable-opcua-server.png){data-zoomable}
...
![Adding OPC UA server interface in TIA Portal](/blog/2025/12/images/add-server-interface.png){data-zoomable}
...
![Attribute settings for optimized and OPC UA accessible data blocks](/blog/2025/12/images/optimized-db-and-accessbile-via-opcua-option.png){data-zoomable}
...
![Tags added inside OPC UA server interface](/blog/2025/12/images/tags-added-in-the-server-interface.png){data-zoomable}
