...
navTitle: Structuring and Storing Data for Effective MES Integration
---
...
![Configuring "JSON Full Schema Validator" node with JSON schema for our data ](/blog/2025/06/images/json-full-validator-node.png){data-zoomable}
...
![Message passes through the second output and includes errors when it does not align with the data schema.](/blog/2025/06/images/invalid-data.png){data-zoomable}
...
![Message passes through the first output and does not include errors when it aligns with the data schema.](/blog/2025/06/images/valid-data-message.png){data-zoomable}
