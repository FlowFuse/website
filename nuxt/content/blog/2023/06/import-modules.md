...
navTitle: Use any npm module in Node-RED
---
...
![Location of the "add" button in order to import an npm module intoa  function node](/blog/2023/06/images/npmimport-add.jpg "Location of the 'add' button in order to import an npm module intoa  function node")
