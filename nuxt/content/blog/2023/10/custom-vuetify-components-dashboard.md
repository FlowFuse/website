...
Like the [template core node](/docs/node-red/core-nodes/function/template/), the dashboard package
...
an [`Inject`](/docs/node-red/core-nodes/common/inject/) node output a random number every second.
...
When dragging in a button node, connect it to a [change](/docs/node-red/core-nodes/function/change/)
