...
![Where your settings file should show](/blog/2023/04/images/ls.png "Where your settings.js should show")
...
![The settings file before being edited](/blog/2023/04/images/without-password.png "The settings file before being edited")
...
![The Node-RED tool outputs the hashed password](/blog/2023/04/images/password.png "The Node-RED tool outputs the hashed password")
...
![The settings file with the relevant section uncommented and the password set](/blog/2023/04/images/with-password.png "The settings file with the relevant section uncommented and the password set")
...
![Using the username and password to login to Node-RED](/blog/2023/04/images/login.gif "Using the username and password to login to Node-RED")
...
![The setting file before turning off the editor](/blog/2023/04/images/editor-on.png "The setting file before turning off the editor")
...
![The setting file after turning off the editor](/blog/2023/04/images/editor-off.png "The setting file after turning off the editor")
...
![Tailscale dashboard showing my three devices](/blog/2023/04/images/tailscale.png "Tailscale dashboard showing my three devices")
...
![Accessing Node-RED via the VPN](/blog/2023/04/images/nr-via-vpn.png "Accessing Node-RED via the VPN")
