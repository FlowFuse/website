...
navTitle: FlowFuse v1.4 with device provisioning in bulk and staged development process
---
...
To make it easy for everyone to experience FlowFuse, we are introducing a new free 30-day trial. You can now experience the power of using FlowFuse to quickly deliver Node-RED applications in a reliable, repeatable, collaborative, and secure manner. To get your free trial simply [sign up for FlowFuse Cloud;](https://app.flowfuse.com/account/create) no credit card is required!
...
[FlowFuse Cloud](https://app.flowfuse.com) is already running 1.4.
