...
description: "Learn three valuable Node-RED tips: search nodes efficiently, split code with link nodes, and wire multiple I/O at once."
...
<video autoplay loop muted playsinline aria-label="Selecting a node without having to use the palette" width="774" height="318" preload="none"><source src="/blog/2023/02/images/load-node.webm" type="video/webm" /></video>
...
<video autoplay loop muted playsinline aria-label="Spliting your nodes with link nodes" width="726" height="440" preload="none"><source src="/blog/2023/02/images/split-with-link.webm" type="video/webm" /></video>
...
<video autoplay loop muted playsinline aria-label="Linking multiple inputs and outputs in one command" width="538" height="362" preload="none"><source src="/blog/2023/02/images/join-wires.webm" type="video/webm" /></video>
