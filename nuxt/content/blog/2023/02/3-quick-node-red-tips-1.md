...
navTitle: Node-RED Tips - Wiring Shortcuts
---
...
![Selecting a node without having to use the palette](/blog/2023/02/images/load-node.gif "Selecting a node without having to use the palette")
...
![Spliting your nodes with link nodes](/blog/2023/02/images/split-with-link.gif "Spliting your nodes with link nodes")
...
!["Linking multiple inputs and outputs in one command"](/blog/2023/02/images/join-wires.gif "Linking multiple inputs and outputs in one command")
