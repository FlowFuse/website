...
navTitle: Some questions we didn't get to in our first webinar
---
...
![Capturing debug to a log file using Flogger](/blog/2023/02/images/flogger.gif "Capturing debug to a log file using Flogger")
...
!["Image showing the Flow where the random number generator sends a message to 4 nodes at the same time"](/blog/2023/02/images/chart-flow.png "Image showing the Flow where the random number generator sends a message to 4 nodes at the same time")
...
!["Image showing how to delete a subflow"](/blog/2023/02/images/delete-subflow.png "Image showing how to delete a subflow")
