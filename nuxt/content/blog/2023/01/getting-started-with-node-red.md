...
navTitle: Getting Started with Node-RED
---
...
!["Screenshot showing the HTTP-in, Change, and HTTP-response nodes that we will be using throughout this blog for demonstration."](/blog/2023/01/images/three-nodes.png "Screenshot showing the HTTP-in, Change, and HTTP-response nodes that we will be using throughout this blog for demonstration.")
...
!["Configuring the change node to set the payload to Hello World"](/blog/2023/01/images/set-reply.png "Configuring the change node to set the payload to Hello World")
...
!["Configuring the status node to set the response to 200"](/blog/2023/01/images/response-code.png "Configuring the status node to set the response to 200")
...
---
height: 200
flow: ""
---
::
