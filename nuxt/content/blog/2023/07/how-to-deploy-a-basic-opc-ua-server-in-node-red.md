...
navTitle: How to Deploy a Basic OPC-UA Server in Node-RED - Part 1
---
...
!["Automation Pyramid"](/blog/2023/07/images/opc-ua-1/automation-pyramid.jpg "Automation Pyramid")
...
!["OPC-UA Pyramid"](/blog/2023/07/images/opc-ua-1/OPC-UA-pyramid-2.webp "OPC-UA Pyramid")
...
!["Fieldbus Model"](/blog/2023/07/images/opc-ua-1/fieldbus-model.png "Fieldbus Model")
...
!["OPC Client Browser"](/blog/2023/07/images/opc-ua-1/opc-client-browser.png "OPC Information Model")
...
!["OPC-UA Distributed Model"](/blog/2023/07/images/opc-ua-1/OPC-UA-distributed-model.jpg "OPC-UA Distributed Model")
...
![Compact Server Flow](/blog/2023/07/images/opc-ua-1/compact-server-flow.png "Compact Server Flow")
...
!["Screenshot showing the Context Data option"](/blog/2023/07/images/opc-ua-1/context-data-1.png "Screenshot showing the Context Data option")


![Screenshot showing the flow variables in the context data tab](/blog/2023/07/images/opc-ua-1/context-data-2.png "Screenshot showing the flow variables in the context data tab")
...
!["Compact Server Node"](/blog/2023/07/images/opc-ua-1/compact-server-node.png "Compact Server Node")
...
![Screenshot showing the Settings Tab of compact server node](/blog/2023/07/images/opc-ua-1/settings-tab.png "Screenshot showing the Settings Tab of compact server node")
...
![Screenshot showing the Security Tab of compact server node](/blog/2023/07/images/opc-ua-1/security-tab.png "Screenshot showing the Security Tab of compact server node")
...
![Screenshot showing the Discovery Tab of compact server node](/blog/2023/07/images/opc-ua-1/discovery-tab.png "Screenshot showing the Discovery Tab of compact server node")
Once the endpoint url is added, deploy the flow, and confirm the server is reporting “active”.

![Screenshot showing the Active Tab of compact server node](/blog/2023/07/images/opc-ua-1/compact-server-active.png "Screenshot showing the Active Tab of compact server node")
...
!["Screenshot showing the OPC Client"](/blog/2023/07/images/opc-ua-1/opc-client-connect.png "Screenshot showing the OPC Client")
...
![OPC Client UI](/blog/2023/07/images/opc-ua-1/opc-client-ui.png)
...
![OPC Client Node](/blog/2023/07/images/opc-ua-1/opc-client-node.png "OPC Client Node")
...
![OPC Client View](/blog/2023/07/images/opc-ua-1/opc-client-view.png)
## Summary
