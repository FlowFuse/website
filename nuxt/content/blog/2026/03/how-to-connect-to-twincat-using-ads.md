...
navTitle: How to Connect to Beckhoff TwinCAT PLC Using ADS (2026)
---
...
![TwinCAT ADS nodes available in the Node-RED palette after installing node-red-contrib-ads-client](/blog/2026/03/images/twincat-ads-nodes.png)
...
![Required settings tab showing Target AMS Net ID and Target ADS Port fields in the ADS connection configuration](/blog/2026/03/images/Twincat-config-required-fields.png)
...
![Optional settings tab showing Router Address, Router TCP Port, Local AMS Net ID and Local ADS Port fields](/blog/2026/03/images/twincat-config-optional-tab.png)
...
![ADS connection status node showing connected state in Node-RED](/blog/2026/03/images/connection-status.png)
...
![ADS Read Value node configuration showing variable name set to MAIN.temperature](/blog/2026/03/images/ads-read-value.png)
...
![ADS Subscribe Value node configuration showing variable name, subscription mode set to On Change, and cycle time set to 100ms](/blog/2026/03/images/ads-subscribe.png)
...
![ADS Write Value node configuration showing variable name set to MAIN.setpoint with autoFill unchecked](/blog/2026/03/images/ads-write.png)
...
![PlcTask properties window showing the Create symbols checkbox enabled](/blog/2026/03/images/create-symbol.png)
