...
navTitle: See Every Logic Change in Your IIoT MOC Review with Git-Style Diffs
---
...
![FlowFuse snapshot diff showing a function node with line-by-line code changes highlighted between two deployments](/blog/2026/05/images/snapshot-function-code-change.png)

For configuration changes, the view shifts to a side-by-side property comparison.

![FlowFuse snapshot diff showing modified node properties with changed configuration values highlighted between two snapshots](/blog/2026/05/images/snapshot-prop-change.png)
...
![Diagram showing the MOC workflow from engineer creating a named snapshot, through reviewer comparison and approval, to snapshot deployment on the edge device](/blog/2026/05/images/moc-to-deployment.png)
