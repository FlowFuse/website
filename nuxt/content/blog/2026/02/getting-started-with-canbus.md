...
navTitle: 'CAN Bus Tutorial: Connect to Dashboards, Cloud, and Industrial Systems'
---
...
![Diagram illustrating the connection flow from FlowFuse, through the SocketCAN layer, down to the OS-level CAN interface (vcan0 or can0)](/blog/2026/02/images/ff-to-canbus.png "diagram illustrating the connection flow from FlowFuse, through the SocketCAN layer, down to the OS-level CAN interface (vcan0 or can0)")
...
![Debug output showing a received CAN message in FlowFuse](/blog/2026/02/images/debug-output-can-message.png "Debug output showing a received CAN message in FlowFuse")
