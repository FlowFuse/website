...
navTitle: 'Modbus TCP vs Modbus RTU: Reliability, Latency, and Failure Modes'
---
...
![Image showing Modbus RTU on RS-485 and Modbus TCP on Ethernet.](/blog/2026/02/images/modbus-rtu-and-tcp-physical-layer.png "Image showing Modbus RTU on RS-485 and Modbus TCP on Ethernet.")
...
![Chart comparing Modbus RTU polling latency with Modbus TCP network latency](/blog/2026/02/images/modbus-rtu-tcp-latency.png "Chart comparing Modbus RTU polling latency with Modbus TCP network latency")
...
![Half-open TCP socket failure where the master waits on a connection that never responds.](/blog/2026/02/images/modbus-tcp-open-connection-failure.png "Half-open TCP socket failure where the master waits on a connection that never responds.")
