            ...
            <div class="md:flex md:flex-col md:justify-between text-left self-start md:h-full">
              <div>
                <h4 class="flex items-center gap-4">
                  <div class="w-16 mt-6">
                    <img src="/images/pictograms/community_blue.png" alt="Graphics depicting low-code programming." width="64">
                  </div>
                  <div class="flex flex-col leading-8 mt-6">
                    <h4>Ask the <span class="text-indigo-600">community</span></h4>
                  </div>
                </h4>
                <p class="mb-0">
                  Explore our forum to find answers and solutions. Others may have already shared similar issues, providing
                  valuable insights that could address your concerns.
                </p>
              </div>
              <div class="container text-center max-w-4xl flex flex-col md:items-start mt-6">
                <CtaCustom label="Community Forum" href="https://discourse.nodered.org/c/vendors/flowfuse/24/" event="cta-community-forum" variant="primary" position="support-forum" />
              </div>
            </div>
            <div class="md:flex md:flex-col md:justify-between text-left self-start md:h-full">
              <div>
                <h4 class="flex items-center gap-4">
                  <div class="w-16 mt-6">
                    <img src="/images/pictograms/speech_blue.png" alt="Graphics depicting low-code programming." width="64">
                  </div>
                  <div class="flex flex-col leading-8 mt-6">
                    <h4>Reach out via our <span class="text-indigo-600">chat</span></h4>
                  </div>
                </h4>
                <p class="mb-0">
              ...
              <div class="container text-center max-w-4xl flex flex-col md:items-start mt-6">
                <button onclick="window.HubSpotConversations?.widget?.open()" class="ff-btn ff-btn--primary flex flex-col">
