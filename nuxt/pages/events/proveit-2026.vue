<script setup>
// Reproduces src/events/proveit-2026.njk (layout: base.njk, nohero).
const title = 'FlowFuse at ProveIt! 2026'
...
useHead({
    title,
    meta: [{ name: 'description', content: 'Join FlowFuse at ProveIt 2026 to learn how to turn manufacturing data into business value. Explore our session, workshop, demos, and meeting opportunities.' }],
})
</script>
        ...
        <div class="w-full flex flex-col max-md:justify-center md:flex-row md:gap-10 mt-3 pb-8 md:pb-12">
          <div class="md:max-w-[390px] flex flex-grow relative ff-image-cover ff-image-rounded w-full max-md:mb-6">
            <div class="event bg-indigo-50 max-md:max-h-[300px] w-full flex-grow ff-image-cover left">
              <img src="/events/images/pi26/proveit26-hero.png" alt="Image of people at the FlowFuse booth" style="max-width:644px" />
            </div>
            <div class="absolute top-5 left-5 w-[170px] h-auto">
              <img src="/events/images/pi26/pi_logo.png" alt="ProveIt! 2026 Logo" style="max-width:170px" />
            </div>
          </div>
          <div class="main-content sm:2/3">
            <label class="text-red-600 font-medium mb-2 capitalize">Trade Show</label>
            <h1 class="md:max-w-screen-md">{{ title }}</h1>
            ...
            <div class="flex flex-wrap items-start sm:justify-start justify-center gap-4 mt-10">
              <a class="ff-btn ff-btn--primary uppercase items-center text-base" href="https://meetings-eu1.hubspot.com/michael-davis/in-person-proveit-meeting?utm_campaign=proveit_2026&utm_source=website&utm_medium=events-page&utm_content=hero-cta">SCHEDULE A MEETING</a>
              <a class="ff-btn ff-btn--primary-outlined uppercase items-center text-base" href="https://www.proveitconference.com/offers/GVr8MysP?coupon_code=FLOWFUSE" target="_blank">GET YOUR DISCOUNTED TICKETS</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="w-full md:bg-white pt-12 md:pt-20 px-6">
      <div class="container flex flex-col md:flex-row m-auto text-left md:max-w-screen-lg md:gap-14 items-stretch">
        <div class="ff-prose mt-3 sm:1/3 flex-grow flex flex-col justify-center">
          ...
          <div class="prose">
            <ul>
              <li v-for="(h, i) in demoHighlights" :key="i">{{ h }}</li>
            </ul>
          </div>
        ...
        <div class="md:max-w-[390px] flex flex-grow relative ff-image-cover ff-image-rounded w-full max-md:mb-6">
          <div class="max-md:max-h-[300px] w-full flex-grow ff-image-cover left">
            <img src="/events/images/pi26/proveit26-booth.png" alt="Image of people attending the FlowFuse demo." style="max-width:644px" />
          </div>
        </div>
      </div>
      <div id="livesession" class="flex flex-col m-auto text-left md:max-w-screen-lg items-stretch mt-6 md:mt-20">
        ...
        <div class="mt-6">
          ...
          <div class="ff-image-rounded w-full mt-6 mb-6">
            <img src="/events/images/pi26/proveit-session.jpg" alt="Banner with details about the on-stage session" style="max-width:1024px" />
          </div>
        ...
        <div class="mt-12">
          ...
          <div class="ff-image-rounded w-full mt-6 mb-6">
            <img src="/events/images/pi26/proveit-workshop.jpg" alt="Banner with details about the hands-on workshop" style="max-width:1024px" />
          </div>
          ...
          <div class="flex sm:justify-end justify-center mt-6">
            <a class="ff-btn ff-btn--primary uppercase items-center text-base sm:w-auto w-full text-center" href="https://www.proveitconference.com/offers/HFdN4Dxb/checkout">SAVE YOUR SPOT TODAY</a>
          </div>
        </div>
        ...
        <div class="flex max-md:flex-col w-full gap-4">
          <div class="ff-prose prose w-full md:2/3">
            ...
            <ul>
              <li v-for="(h, i) in sessionHighlights" :key="i">{{ h }}</li>
            </ul>
          </div>
          <div class="bg-indigo-50/50 rounded-lg p-6 w-full md:max-w-[390px] flex flex-col justify-center max-md:mb-6">
            ...
            <div class="flex sm:order-2 order-3 mt-4">
              <a class="ff-btn ff-btn--primary-outlined uppercase items-center text-base mx-auto" href="https://meetings-eu1.hubspot.com/michael-davis/in-person-proveit-meeting?utm_campaign=proveit_2026&utm_source=website&utm_medium=events-page&utm_content=hero-cta">SCHEDULE A MEETING</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container md:max-w-screen-lg p-8 border-2 border-indigo-200 rounded-lg bg-white drop-shadow-lg m-auto mt-10 md:mt-20 grid grid-cols-1 sm:grid-cols-3 sm:grid-flow-col sm:gap-x-6 sm:py-0 sm:grid-rows-[100px_minmax(20px,_1fr)]">
        ...
        <div class="flex items-start justify-start sm:order-2 order-3 sm:self-end sm:pb-6 max-sm:mt-6">
          <a class="ff-btn ff-btn--primary uppercase items-center text-base" href="/book-demo/">BOOK A DEMO</a>
        </div>
      </div>
    </div>
  </div>
