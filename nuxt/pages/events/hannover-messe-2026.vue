...
const DEMO_IMAGE = {
    src: '/events/images/hm26/hm-26-demo.png',
    alt: 'Image of people attending the FlowFuse demo.',
}

const DEMO_HIGHLIGHTS = [
    'A live connected production line demo (PLCs, MES, ERP, and cloud fully integrated via Node-RED)',
    'Real-time data flow across the complete ISA-95 architecture',
    'Seamless integration with your existing IT and OT systems',
    'AI-powered development capabilities with FlowFuse Expert',
    'Practical demonstrations showing how to make your industrial data AI-ready',
]
...
const META_DESCRIPTION = 'Visit FlowFuse at Hannover Messe 2026 in Hall 014, Stand K26 for live demos, special sessions, and industrial connectivity in action.'

useSeoMeta({
    title: 'FlowFuse at Hannover Messe 2026',
    description: META_DESCRIPTION,
    ogDescription: META_DESCRIPTION,
    ogUrl: 'https://flowfuse.com/events/hannover-messe-2026/',
  ...
  <div class="w-full">
          ...
          <div class="w-full flex flex-col max-md:justify-center md:flex-row md:gap-10 mt-3 pb-8 md:pb-12">
            ...
            <div class="main-content sm:2/3">
              ...
              <div class="flex flex-wrap items-center justify-start gap-x-6 gap-y-4 mt-10">
                <a
                    class="ff-btn ff-btn--highlight uppercase items-center text-base"
      ...
      <div class="w-full md:bg-white pt-12 md:pt-20 px-6">
        <div class="container flex flex-col md:flex-row m-auto text-left md:gap-14 items-stretch md:max-w-screen-lg">
          <div class="ff-prose mt-3 sm:1/3 flex-grow">
            ...
            <div class="prose">
              <ul>
                <li v-for="highlight in DEMO_HIGHLIGHTS" :key="highlight">{{ highlight }}</li>
              </ul>
            </div>
          </div>
          <div class="md:max-w-[390px] flex flex-grow w-full max-md:mt-6">
            <div class="ff-image-cover top ff-image-rounded max-md:max-h-[300px] w-full md:h-full flex-grow">
              <img :src="DEMO_IMAGE.src" :alt="DEMO_IMAGE.alt" width="644" class="w-full h-auto">
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="w-full px-6 py-14 md:py-20 bg-indigo-50">
      <div id="special-sessions" class="container flex flex-col m-auto text-left items-stretch md:max-w-screen-lg scroll-mt-8 md:scroll-mt-12">
        ...
        <div
            v-for="(session, i) in SPECIAL_SESSIONS"
            :id="session.id"
            :key="session.title"
            class="rounded-xl border border-gray-200 bg-white p-4 sm:p-4 md:p-3 flex flex-col md:flex-row gap-5 items-center md:items-stretch drop-shadow-sm scroll-mt-8 md:scroll-mt-12"
            :class="{ 'mt-6': i > 0 }"
        >
          <div class="w-full h-[300px] ff-image-cover ff-image-rounded md:w-[240px] md:h-auto md:self-stretch shrink-0" :class="session.imageClass">
            <img :src="session.image" :alt="session.imgAlt" width="263" class="w-full h-auto">
          </div>
          <div class="flex-grow py-2 md:pr-4 md:flex md:flex-col md:justify-center">
            ...
            <div class="mt-4 flex flex-col sm:flex-row sm:flex-wrap gap-6">
              <a class="ff-btn ff-btn--primary uppercase inline-flex items-center text-base w-full md:w-auto justify-center" :href="session.ctaUrl">
                {{ session.cta }}
              </a>
              <a
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-5 md:gap-6">
          <div v-for="day in AGENDA.days" :key="day.dateLabel" class="flex flex-col gap-3">
            ...
            <a
                ...
                :key="talk.title"
                class="group relative rounded-xl bg-indigo-500 p-4 text-white no-underline hover:no-underline transition-all duration-200 ease-out hover:-translate-y-1 hover:bg-indigo-700 hover:shadow-[0_14px_28px_rgba(67,56,202,0.22)] focus-visible:-translate-y-1 focus-visible:bg-indigo-700 focus-visible:shadow-[0_14px_28px_rgba(67,56,202,0.22)]"
                :href="AGENDA.ctaUrl"
            >
      ...
      <div id="livesession" class="container flex flex-col m-auto text-left items-stretch md:max-w-screen-lg">
        ...
        <div class="flex max-md:flex-col w-full gap-6 mt-6">
          <div class="ff-prose prose w-full md:2/3 text-white">
            ...
            <ul>
              <li v-for="point in LIVE_DEMO_POINTS" :key="point">{{ point }}</li>
            </ul>
          </div>
          <div class="bg-white rounded-lg border-2 border-red-100 p-6 w-full max-w-[448px] sm:max-w-[896px] md:max-w-[350px] flex flex-col justify-center mx-auto max-md:my-6">
            ...
            <div class="flex sm:order-2 order-3 mt-4">
              <a class="ff-btn ff-btn--highlight uppercase items-center text-base mx-auto" href="https://meetings-eu1.hubspot.com/zeger-jan/quick-flowfuse-chat">
                SCHEDULE A MEETING
              </a>
            </div>
          </div>
        ...
        <div class="ff-blue-card p-8 m-auto grid grid-cols-1 sm:grid-cols-[1fr_2fr] gap-8 sm:gap-x-10 items-center">
          <div class="flex flex-col gap-6 sm:gap-8 sm:justify-center order-1">
            ...
            <div class="hidden sm:flex items-start justify-center sm:justify-start">
              <CtaBookDemo variant="primary" position="hannover-messe-2026" uppercase class="items-center text-base" />
            </div>
          </div>
          ...
          <div class="flex justify-center order-3 sm:hidden">
            <CtaBookDemo variant="primary" position="hannover-messe-2026-mobile" uppercase class="items-center text-base" />
          </div>
        </div>
      </div>
    </div>
