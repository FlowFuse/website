      ...
      <div class="pt-12 max-w-screen-lg mx-auto">
        ...
        <div class="mt-24">
          ...
          <div class="max-w-screen-lg mx-auto pt-8 pb-20 text-center lg:text-left">
            ...
            <NuxtLink class="mt-6 inline-flex items-center gap-1 font-medium text-indigo-600 hover:underline" to="/getting-started/" @click="capture('cta-learn-more', { position: 'getting-started' })">Get started building &rarr;</NuxtLink>
            <div class="mt-10">
