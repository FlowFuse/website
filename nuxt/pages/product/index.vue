...
const DIFFERENTIATORS = [
    {
        ...
        description: 'Every factory is different, so why deploy the same solution as everyone else? Build your way with ready-made blueprints, your own app store, or anything in between — we never dictate your tools.',
    },
    {
        heading: 'Flexible and Secure',
        description: 'From whole-factory rollouts to last-mile fixes across any industry. Build your solution, then secure it with granular RBAC, auditing, version control, and traceability.',
    },
    {
        ...
        <div class="mt-24">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            ...
            >
              ...
              <p class="mb-0">{{ diff.description }}</p>
            </div>
          </div>
              ...
              <div class="flex-1 min-w-0 flex flex-col gap-20">
                ...
                >
                  <div class="flex flex-col justify-center text-center md:text-left">
                    ...
                    <ProseNote class="mt-4">{{ tier.idealFit }}</ProseNote>
