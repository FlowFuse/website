  ...
  <div class="nohero w-full">
    <div class="w-full px-6">
      ...
      <div v-if="page.problem" class="max-w-screen-lg mx-auto mb-4">
        <!-- eslint-disable-next-line vue/no-v-html -->
        <h2 class="text-center w-full md:text-left max-w-4xl" v-html="page.problem.title" />
        <!-- eslint-disable-next-line vue/no-v-html -->
        <p v-for="(paragraph, i) in page.problem.description" :key="i" v-html="paragraph" />
      </div>
    </div>
    ...
    <div v-if="page.solution" class="w-full bg-indigo-50/50 py-16 my-16 px-6">
      <div class="md:max-w-screen-lg m-auto">
        <!-- eslint-disable-next-line vue/no-v-html -->
        <h2 class="text-center w-full md:text-left max-w-4xl" v-html="page.solution.title" />
    ...
    <div class="w-full px-6 pt-6">
      <div class="max-w-screen-lg mx-auto mb-4">
        <!-- eslint-disable-next-line vue/no-v-html -->
        <h2 class="text-center w-full md:text-left max-w-4xl" v-html="page.testimonialsTitle" />
        ...
        <template v-if="page.useCases">
          <!-- eslint-disable-next-line vue/no-v-html -->
          <h2 class="text-center w-full md:text-left max-w-4xl" v-html="page.useCases.title" />
          <div class="max-w-md sm:max-w-screen-lg m-auto my-10">
    ...
    <div v-if="page.how" class="w-full bg-indigo-50/50 py-16 my-16 px-6">
      <div class="md:max-w-screen-lg m-auto">
        <!-- eslint-disable-next-line vue/no-v-html -->
        <h2 class="text-center w-full md:text-left max-w-4xl" v-html="page.how.title" />
    ...
    <div v-if="page.features" class="w-full px-6">
      <div class="max-w-screen-lg mx-auto mb-4">
        <!-- eslint-disable-next-line vue/no-v-html -->
        <h2 class="text-center w-full md:text-left max-w-4xl mb-10" v-html="page.features.title" />
