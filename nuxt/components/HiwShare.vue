...
// Copy-the-current-URL share button for the how-it-works guide. Lives in the
...
async function share () {
  ...
  if (typeof (window as any).capture === 'function') {
    (window as any).capture('hiw-share', { url })
  }
}
</script>
...
.hiw-share:hover { background: #eef2ff; border-color: #c7d2fe; }
.hiw-share svg { width: 1rem; height: 1rem; }
.hiw-share--copied { color: #0f766e; border-color: #99e6da; background: #e6faf6; }
</style>
