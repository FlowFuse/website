    ...
    <footer class="ff-footer bg-gray-100 w-full border-t border-white">
      ...
      <section class="mt-12 border-t border-gray-300 pt-5">
          <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-x-8 gap-y-8 text-sm">
            ...
            <defs>
              <linearGradient id="ffWaveWordmarkFooter" gradientUnits="userSpaceOnUse" x1="0" y1="0" x2="402" y2="0">
                <stop offset="0" stop-color="#1F2937" />
                <stop offset="0.25" stop-color="#1F2937" />
                <stop offset="0.5" stop-color="#1F2937" />
                <stop offset="0.75" stop-color="#1F2937" />
