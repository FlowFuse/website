        ...
        <li class="ff-nav-dropdown relative hover:cursor-pointer">
          ...
          <ul class="narrow mega md:grid md:grid-flow-col md:grid-rows-[repeat(12,auto)] md:pr-1 md:auto-rows-auto items-center">
            ...
            <ul class="sub-menu grid grid-rows-subgrid row-span-[9] ml-7 auto-rows-auto border-l-2 border-gray-200 md:col-start-2 md:row-start-2 xl:col-start-3">
              ...
              <li><a class="flex items-center gap-2" href="/industries/food-beverage/"><svg class="ff-icon ff-icon-sm" viewBox="0 0 24 24" fill="none" stroke-width="1.5"><path d="M5 3V8.5C5 10.1569 6.34315 11.5 8 11.5C9.65685 11.5 11 10.1569 11 8.5V3" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path d="M6.75 3V7.5" stroke="currentColor" stroke-linecap="round"/><path d="M9.25 3V7.5" stroke="currentColor" stroke-linecap="round"/><path d="M8 11.5V21" stroke="currentColor" stroke-linecap="round"/><path d="M14 3H20L19 21H15L14 3Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path d="M14.35 9.5H19.65" stroke="currentColor" stroke-linecap="round"/></svg><span class="ff-nav-label">Food &amp; Beverage</span></a></li>
