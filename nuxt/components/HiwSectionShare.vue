...
<style scoped>
.hiw-secshare { display: inline-flex; align-items: center; gap: .35rem; font-size: .74rem; font-weight: 700; color: #64748b; background: #fff; border: 1px solid #e5e7eb; border-radius: 9999px; padding: .32rem .7rem; cursor: pointer; transition: color .15s ease, border-color .15s ease, background .15s ease; }
.hiw-secshare:hover { color: #4f46e5; border-color: #c7d2fe; background: #f5f7ff; }
.hiw-secshare svg { width: .9rem; height: .9rem; }
.hiw-secshare.is-copied { color: #0f766e; border-color: #99e6da; background: #e6faf6; }
</style>
