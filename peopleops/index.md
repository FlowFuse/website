...
All expenses on Brex require a memo to be submitted what the expense if for, and
expenses made equal or more than $25 require a receipt to be uploaded. Attaching
a receipt to an expense can be done through their web UI, forwarding receipts
through email, or through Slack. For full explanation, please [read their docs][brex-receipts].
