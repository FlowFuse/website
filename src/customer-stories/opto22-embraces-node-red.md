...
Opto 22 early adoption of Node-RED has certainly proven the correct choice. Opto 22 customers benefit from an open, low-code platform for creating innovative new industrial applications. Opto 22 has attracted a wider community of industrial engineers who are interested in using modern, open tools. Opto 22 continues to be an innovator in the industrial hardware industry. Other edge hardware integrators are building on the same foundation: [STFI uses Node-RED to bridge proprietary equipment protocols to OPC-UA in its textile Model Factory](/customer-stories/stfi-future-of-textile-powered-by-node-red/), and [Abrasive Technology runs Node-RED on edge hardware for precision manufacturing automation](/customer-stories/leveraging-node-red-and-flowfuse-to-automate-precision-manufacturing/).
