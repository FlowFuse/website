...
Before they began their digital transformation, the company’s manufacturing data was recorded on paper or not accessible from the manufacturing machinery. It was very difficult to provide a holistic visibility of the operations, predict future maintenance requirements or proactively react to events on the [shop floor](/use-cases/shop-floor-communication/). The company's [MES system](/use-cases/mes/) was focused on what to build and how to build it but not measuring, understanding or improving the processes.
...
The company is using the FlowFuse platform to address these challenges. **They are using FlowFuse to manage the deployment of Node-RED instances out to thousands of remote devices and maintain multiple versions of the instances**. In addition, they use FlowFuse delivery pipelines and collaboration tools to improve the reliability and efficiency of their development processes. Other manufacturers have hit the same wall at scale: [Arch Systems now automates 100+ databases across its global manufacturing environments with FlowFuse](/customer-stories/scaling-manufacturing-automation-with-flowfuse/), while [Walter grew from 1 to 130+ Node-RED instances without adding to its IT team](/customer-stories/scaling-industrial-iot-operations-while-maintaining-competitive-edge/).

Overall, **the project leader sees Node-RED as the future of software development**. The low code paradigm makes it possible for companies to decentralize innovation within an organization, allowing subject matter experts to build digital systems that drive innovation. [Abrasive Technology's manufacturing engineers took the same approach](/customer-stories/leveraging-node-red-and-flowfuse-to-automate-precision-manufacturing/), using Node-RED to build their own precision manufacturing applications.
