...
When deploying the FlowFuse platform behind a firewall or proxy, ensure that the following ports are open and forwards a traffic to the server where FlowFuse is installed:
* Port `80` (HTTP)
* Port `443` (HTTPS)
