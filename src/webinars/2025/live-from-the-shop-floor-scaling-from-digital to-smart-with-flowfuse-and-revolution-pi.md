...
In this webinar, Boris Crismancich from Revolution Pi was live at scale expert [Essmann Waagen](https://essmann.com/en/), demonstrating how FlowFuse and Revolution Pi transform a traditional counting scale workflow into a smart, ERP-connected system.
...
- Building of an automated warehouse picking process with ERP integration
...
Watch how Boris transformed an isolated counting scale into a smart, connected workflow in real-time, including ERP integration, touchscreen operator guidance, quantity verification, and AI-powered package inspection.
