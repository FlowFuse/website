...
The `Customer Request` label is intended solely for issues requested by an importnat enterprise customer, not for leads or individuals like [Harry the Hobbyist](../product/personas/index.md). 
