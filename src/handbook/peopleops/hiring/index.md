...
1. Create the contract in Deel, and purchase the [background check](/handbook/company/security/human-resources/#screening).
   ...
   * Note: If we are hiring via PEO in a state where we do not currently have any employees, notify Operations immediately to begin the registered agent filing process.
