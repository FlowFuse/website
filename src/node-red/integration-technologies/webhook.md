...
<video autoplay loop muted playsinline aria-label="Video displaying the flow of scheduled maintenance table"><source src="./images/using-webhook-with-node-red-scheduled-maintenance-table-dashboard-view.webm" type="video/webm"></source></video>