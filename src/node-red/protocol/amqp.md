...
<video autoplay loop muted playsinline aria-label="Video showing the flow that uses the Direct exchange type to send messages and receive messages" width="1918" height="792" preload="none"><source src="/node-red/protocol/images/direct.webm" type="video/webm" /></video>
...
<video autoplay loop muted playsinline aria-label="Video showing the flow that uses the Topic exchange type to send messages and receive messages." width="1920" height="826" preload="none"><source src="/node-red/protocol/images/topic.webm" type="video/webm" /></video>
...
<video autoplay loop muted playsinline aria-label="Video showing the flow that uses the Fanout exchange type to send messages and receive messages." width="1918" height="824" preload="none"><source src="/node-red/protocol/images/fanout.webm" type="video/webm" /></video>
...
<video autoplay loop muted playsinline aria-label="Video showing the flow that uses the Headers exchange type to send messages and receive messages." width="1908" height="844" preload="none"><source src="/node-red/protocol/images/header.webm" type="video/webm" /></video>
