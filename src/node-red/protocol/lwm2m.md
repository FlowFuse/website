...
<video autoplay loop muted playsinline aria-label="Video showing LwM2M Server reading the device details"><source src="/node-red/protocol/images/lwm2m-server-reading.webm" type="video/webm"></source></video>
...
<video autoplay loop muted playsinline aria-label="Video showing how to perform write operation in the LwM2M server"><source src="/node-red/protocol/images/writing-in-server.webm" type="video/webm"></source></video>
...
<video autoplay loop muted playsinline aria-label="Video showing the LwM2M server executing reboot command for device"><source src="/node-red/protocol/images/executing-command-from-server.webm" type="video/webm"></source></video>
...
<video autoplay loop muted playsinline aria-label="Video showing Node-RED flow that reading data from LwM2M Server"><source src="/node-red/protocol/images/reading-data-from-server-in-nr.webm" type="video/webm"></source></video>
...
<video autoplay loop muted playsinline aria-label="Video showing Node-RED flow that writing data to LwM2M Server"><source src="/node-red/protocol/images/writing-data-to-server-from-nr.webm" type="video/webm"></source></video>
