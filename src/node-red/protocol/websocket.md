...
<video autoplay loop muted playsinline aria-label="Testing Server with Client" width="1920" height="832" preload="none"><source src="/node-red/protocol/images/server-testing.webm" type="video/webm" /></video>
...
<video autoplay loop muted playsinline aria-label="Testing Client with Server" width="1920" height="832" preload="none"><source src="/node-red/protocol/images/client-testing.webm" type="video/webm" /></video>
