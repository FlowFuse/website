...
<video autoplay loop muted playsinline aria-label="Testing Server with Client"><source src="/node-red/protocol/images/server-testing.webm" type="video/webm"></source></video>
...
<video autoplay loop muted playsinline aria-label="Testing Client with Server"><source src="/node-red/protocol/images/client-testing.webm" type="video/webm"></source></video>
