...
Clicking on the left instance name redirects you to that instance's advanced options provided by the [FlowFuse Cloud](/). These options include overview, edge devices assigned to that instance, audit logs for monitoring instance activities, settings and more.
...
This option navigates you to the [FlowFuse Cloud's](/) advance options.
