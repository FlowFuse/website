...
<video autoplay loop muted playsinline aria-label="capturing images using webcam widget controls"><source src="./images/using_webcam_with_node-red_capturing_images_by_control.webm" type="video/webm"></source></video>
...
<video autoplay loop muted playsinline aria-label="capturing images by passing payload"><source src="./images/using_webcam_with_node-red_capturing_images_by_passing_payload.webm" type="video/webm"></source></video>
...
<video autoplay loop muted playsinline aria-label="selecting different camera"><source src="./images/using_webcam_with_node-red_selecting_different_camera.webm" type="video/webm"></source></video>
