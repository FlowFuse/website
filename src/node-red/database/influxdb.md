...
<video autoplay loop muted playsinline aria-label="Checking the data has arrived in InfluxDB"><source src="./images/data_in_influx.webm" type="video/webm"></source></video>
