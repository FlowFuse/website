...
solution:
  ...
  benefits:
    - svgPath: "components/icons/link.svg"
      text: "One platform to <strong>connect inspection and production data</strong> (CMMs, torque tools, machining centres, special process records) with ERP and quality systems."
    - svgPath: "components/icons/bolt.svg"
      text: "Low-code automation built on Node-RED so engineers can <strong>configure and iterate compliance workflows without specialist IT involvement</strong>."
    - svgPath: "components/icons/rectangle-stack.svg"
      text: "Dev/test/prod environments to <strong>safely replicate validated workflows across machining cells and additional sites</strong> as the business grows."
solutionImage: "images/industries/aerospace-components-solution.svg"
outcomes:
  title: "Key Outcomes"
  subtitle: "for Aerospace Component Manufacturers"
  items:
    - svgPath: "components/icons/bolt.svg"
