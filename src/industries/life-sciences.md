...
useCases:
  ...
  items:
    ...
    - image: "/images/industries/life-sciences-use-case-2.jpg"
      ...
      description: "<strong>Continuous Electronic Batch Record assembly</strong><br>process parameters, equipment status, operator confirmations, and quality results captured at each step as the batch progresses; EBR complete and QA-ready at end of production with discrepancies flagged in real time, not during post-production review."
