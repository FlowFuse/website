...
1.  Login to the FlowFuse platform. If you don't have an account, you can register for a [free trial]({{ site.onboardingURL }}) to get started. Once registered, create a FlowFuse instance and open its editor.
