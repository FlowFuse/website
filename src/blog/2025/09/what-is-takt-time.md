...
<video autoplay loop muted playsinline aria-label="Simple takt time display dashboard built with FlowFuse"><source src="./images/takt-time-flowfuse.webm" type="video/webm"></source></video>
