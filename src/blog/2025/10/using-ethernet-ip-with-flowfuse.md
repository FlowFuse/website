...
- Use the [FlowFuse Device Agent](/platform/device-agent/) to install Node-RED on your edge device.
...
<video autoplay loop muted playsinline aria-label="Adding tags to read and write"><source src="/blog/2025/10/images/adding-tags.webm" type="video/webm"></source></video>
