...
- **A running FlowFuse instance** – If you don’t have one yet, [sign up]({% include "main-cta-url.njk" %}) for FlowFuse and set up an instance on your edge device. This device will manage data collection and logging from your PLC using Node-RED.
