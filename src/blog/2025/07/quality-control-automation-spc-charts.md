...
First, open your FlowFuse Node-RED instance. If you don't have one yet, you can [sign up for a free account]({{ site.onboardingURL }}) and have an instance running in minutes.
...
1. **[Start Free with FlowFuse]({{ site.onboardingURL }})** - Get your instance running in minutes
...
**[Build Your First SPC Dashboard Now →]({{ site.onboardingURL }})**
