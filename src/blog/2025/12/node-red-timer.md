...
{% renderFlow 300 %}
[{"id":"c82e994221df40a6","type":"group","z":"b446dfa04d79d359","style":{"stroke":"#b2b3bd","stroke-opacity":"1","fill":"#f2f3fb","fill-opacity":"0.5","label":true,"label-position":"nw","color":"#32333b"},"nodes":["511cf76648f20cf9","39a27898502508ae","7cbb75729fddda2b","0d32703a5c727d17","4d960a09be17c4d1"],"x":94,"y":2659,"w":692,"h":122},{"id":"511cf76648f20cf9","type":"countdown","z":"b446dfa04d79d359","g":"c82e994221df40a6","name":"","topic":"","payloadTimerStart":"true","payloadTimerStartType":"bool","payloadTimerStop":"false","payloadTimerStopType":"bool","timer":"30","resetWhileRunning":false,"outputOnReset":false,"setTimeToNewWhileRunning":false,"startCountdownOnControlMessage":false,"x":510,"y":2720,"wires":[["7cbb75729fddda2b"],["0d32703a5c727d17"]]},{"id":"39a27898502508ae","type":"inject","z":"b446dfa04d79d359","g":"c82e994221df40a6","name":"Start","props":[],"repeat":"","crontab":"","once":false,"onceDelay":0.1,"topic":"","x":190,"y":2720,"wires":[["4d960a09be17c4d1"]]},{"id":"7cbb75729fddda2b","type":"debug","z":"b446dfa04d79d359","g":"c82e994221df40a6","name":"Result","active":true,"tosidebar":true,"console":false,"tostatus":false,"complete":"payload","targetType":"msg","statusVal":"","statusType":"auto","x":650,"y":2700,"wires":[]},{"id":"0d32703a5c727d17","type":"debug","z":"b446dfa04d79d359","g":"c82e994221df40a6","name":"Countdown","active":true,"tosidebar":true,"console":false,"tostatus":false,"complete":"payload","targetType":"msg","statusVal":"","statusType":"auto","x":670,"y":2740,"wires":[]},{"id":"4d960a09be17c4d1","type":"change","z":"b446dfa04d79d359","g":"c82e994221df40a6","name":"Set Countdown","rules":[{"t":"set","p":"payload","pt":"msg","to":"50","tot":"num"},{"t":"set","p":"topic","pt":"msg","to":"control","tot":"str"}],"action":"","property":"","from":"","to":"","reg":false,"x":340,"y":2720,"wires":[["511cf76648f20cf9"]]},{"id":"c4d1be09399c9402","type":"global-config","env":[],"modules":{"node-red-contrib-countdown":"1.3.2"}}]
{% endrenderFlow %}
