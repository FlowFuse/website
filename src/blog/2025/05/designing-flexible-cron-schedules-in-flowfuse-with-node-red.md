...
If you are willing to see all of the dynamic schedules of the specific node, double-click on it and click on the 'Dynamic Schedules' button from the configuration panel. This will show all of the dynamic schedules associated with that node.
