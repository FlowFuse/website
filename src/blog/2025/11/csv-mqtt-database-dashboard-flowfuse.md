...
<video autoplay loop muted playsinline aria-label="Dashboard showing real-time line chart with temperature data updating as new MQTT messages arrive"><source src="./images/flowfuse-dashboard.webm" type="video/webm"></source></video>
