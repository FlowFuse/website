...
{% renderFlow %}
[{"id":"975c73527825cf10","type":"group","z":"a3aa840957f658c6","name":"ForLoop","style":{"label":true},"nodes":["a451e2165050da1e","9609eb665cdc92bc","fd49a1efd07934b8","bafa5b687c95f243","d09d0a382e34aa28","56d7586c8e43cc82","787397e5d7010d01","d156608290ef1efb"],"x":714,"y":2059,"w":1052,"h":242},{"id":"a451e2165050da1e","type":"switch","z":"a3aa840957f658c6","g":"975c73527825cf10","name":"if msg.i == msg.payload.length","property":"i","propertyType":"msg","rules":[{"t":"eq","v":"payload.length","vt":"msg"},{"t":"else"}],"checkall":"true","repair":false,"outputs":2,"x":1350,"y":2160,"wires":[["56d7586c8e43cc82"],["d156608290ef1efb","787397e5d7010d01"]]},{"id":"9609eb665cdc92bc","type":"debug","z":"a3aa840957f658c6","g":"975c73527825cf10","name":"End","active":true,"tosidebar":true,"console":false,"tostatus":false,"complete":"true","targetType":"full","statusVal":"","statusType":"auto","x":1650,"y":2100,"wires":[]},{"id":"fd49a1efd07934b8","type":"debug","z":"a3aa840957f658c6","g":"975c73527825cf10","name":"Output \"i\"","active":true,"tosidebar":true,"console":false,"tostatus":false,"complete":"payload","targetType":"msg","statusVal":"","statusType":"auto","x":1660,"y":2260,"wires":[]},{"id":"bafa5b687c95f243","type":"inject","z":"a3aa840957f658c6","g":"975c73527825cf10","name":"Start","props":[{"p":"payload"}],"repeat":"","crontab":"","once":false,"onceDelay":"","topic":"","payload":"[\"hello\",\"run\",\"why\"]","payloadType":"json","x":810,"y":2160,"wires":[["d09d0a382e34aa28"]]},{"id":"d09d0a382e34aa28","type":"change","z":"a3aa840957f658c6","g":"975c73527825cf10","name":"initilized i with empty string","rules":[{"t":"set","p":"i","pt":"msg","to":"0","tot":"num"}],"action":"","property":"","from":"","to":"","reg":false,"x":1040,"y":2160,"wires":[["a451e2165050da1e"]]},{"id":"56d7586c8e43cc82","type":"change","z":"a3aa840957f658c6","g":"975c73527825cf10","name":"Set completed","rules":[{"t":"set","p":"payload","pt":"msg","to":"Completed","tot":"str"}],"action":"","property":"","from":"","to":"","reg":false,"x":1460,"y":2100,"wires":[["9609eb665cdc92bc"]]},{"id":"787397e5d7010d01","type":"change","z":"a3aa840957f658c6","g":"975c73527825cf10","name":"","rules":[{"t":"set","p":"payload","pt":"msg","to":"payload[msg.i]","tot":"msg"}],"action":"","property":"","from":"","to":"","reg":false,"x":1440,"y":2260,"wires":[["fd49a1efd07934b8"]]},{"id":"d156608290ef1efb","type":"change","z":"a3aa840957f658c6","g":"975c73527825cf10","name":"","rules":[{"t":"set","p":"i","pt":"msg","to":"i+1","tot":"jsonata"}],"action":"","property":"","from":"","to":"","reg":false,"x":1160,"y":2260,"wires":[["a451e2165050da1e"]]}]
{% endrenderFlow %}
