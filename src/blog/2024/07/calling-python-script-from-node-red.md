...
<video autoplay loop muted playsinline aria-label="Video showing the Node-RED flow executing the python script that reads the sensor data" width="800" height="450" preload="none"><source src="/blog/2024/07/images/calling-python-scrpt-from-node-red-output.webm" type="video/webm" /></video>
