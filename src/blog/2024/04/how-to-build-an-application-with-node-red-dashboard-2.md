...
<video autoplay loop muted playsinline aria-label="Video of the Todo application built with Node-RED Dashboard 2.0"><source src="./images/building-an-application-with-dashboard-2-task-management-system.webm" type="video/webm"></source></video>
