...
cta:
  type: sign-up
  title: Build and Deploy Node-RED Dashboards in Minutes
...
<video autoplay loop muted playsinline aria-label="Income-expense tracker built with dashboard 2.0"><source src="/blog/2024/05/images/exploring-dashboard-2-widgets-incom-expense-tracker-system.webm" type="video/webm"></source></video>
...
- [Comprehensive guide: Node-RED Dashboard 2.0 layout, sidebar, and styling](/blog/2024/05/node-red-dashboard-2-layout-navigation-styling/) - This comprehensive guide will cover everything about Node-RED Dashboard 2.0 styling, layouts and sidebars.
