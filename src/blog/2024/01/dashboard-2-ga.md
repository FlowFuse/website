---
title: Multi-user Dashboards with FlowFuse & Dashboard 2.0!
subtitle: This week seems our first, full stable version release of Node-RED Dashboard 2.0, as well as some unique, FlowFuse-only features for running multi-user Dashboards.
description: This week seems our first, full stable version release of Node-RED Dashboard 2.0, as well as some unique, FlowFuse-only features for running multi-user Dashboards.
date: 2024-01-16
authors: ["joe-pavitt"]
...
<figcaption class="-mt-6 text-center"><b>The "Admin" view that is only made available to users registered as an "admin".</b></figcaption>
