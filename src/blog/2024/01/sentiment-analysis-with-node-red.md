...
<video autoplay loop muted playsinline aria-label="Sentiment analysis on Text using Node-RED Dashboard 2.0"><source src="./images/sentiment-analysis-dashboard-gif.webm" type="video/webm"></source></video>
