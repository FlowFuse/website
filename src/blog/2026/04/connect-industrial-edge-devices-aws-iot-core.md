...
<video autoplay loop muted playsinline aria-label="AWS IoT Core MQTT test client showing the successfully received JSON payload on the flowfuse/telemetry topic"><source src="/blog/2026/04/images/flowfuse-to-aws.webm" type="video/webm"></source></video>
