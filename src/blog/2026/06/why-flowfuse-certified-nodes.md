...
Right now, FlowFuse offers [[Certified Nodes](/integrations/?certified=1)](/integrations/?certified=1) across a focused, high-value set of integrations, split across two categories: FlowFuse Edge and FlowFuse Hub. This includes official support for [[Redis](/node-red/flowfuse/hub/redis)](/node-red/flowfuse/hub/redis) under Hub, and the [[CIP Suite](/node-red/flowfuse/edge/cip-suite)](/node-red/flowfuse/edge/cip-suite) for Allen-Bradley/EtherNet-IP devices, [[OPC UA](/node-red/flowfuse/edge/opcua/)](/node-red/flowfuse/edge/opcua/), and [[RTSP](/node-red/flowfuse/edge/rtsp/)](/node-red/flowfuse/edge/rtsp/) under Edge. We're actively expanding this catalogue, with major additions planned in the coming weeks to cover even more devices and systems.
