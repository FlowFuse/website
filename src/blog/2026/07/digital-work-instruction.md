...
From there, you can extend the application with production history, quality tracking, role-based experiences, and the [OEE, downtime, and quality dashboards](/blog/2026/08/manufacturing-dashboard-examples/) that run alongside it, all powered by the same operator identity. To see how FlowFuse fits into modern automotive manufacturing, explore the [Automotive solutions page](/industries/automotive/).
