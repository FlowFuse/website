---
title: "What Is a Layered Process Audit (LPA)?"
subtitle: "Understand how LPAs work, what the different layers mean, and how manufacturers use them to verify critical process controls."
...
meta:
  faq:
    - question: "What is a layered process audit?"
      answer: "A layered process audit (LPA) is a structured audit used to verify that critical manufacturing process controls are being followed. Different levels of management perform the audits at different frequencies."
    - question: "How often should layered process audits be performed?"
      answer: "LPA frequency depends on the risk and requirements of the process. A common approach is for supervisors to audit more frequently than area managers and plant leadership."
    - question: "Who performs layered process audits?"
      answer: "Layered process audits are typically performed by different levels of management, such as supervisors, area managers, and plant leadership."
    - question: "What is the difference between an LPA and a process audit?"
      answer: "An LPA is a short, frequent check of selected critical process controls performed by multiple management levels. A process audit is generally broader and provides a more detailed assessment of the overall process."
    - question: "Are layered process audits required by IATF 16949?"
      answer: "IATF 16949 requires process audits but does not specifically mandate the layered process audit format. LPAs may be required by individual customers or other customer-specific requirements."
cta:
  type: contact
...
tldr: "A layered process audit (LPA) is a structured way to verify critical manufacturing process controls through regular checks by different levels of management."
---
