...
<div class="mt-4 flex flex-col">
    ...
    <div class="flex flex-col md:flex-row">
        ...
        <input type="submit" value="Sign Up" class="ff-btn cursor-pointer mt-2 md:mt-0 md:ml-3 py-2 px-4 text-white font-semibold rounded bg-blue-hero border-2 border-blue-hero hover:bg-blue-hero-darker hover:border-blue-hero-darker"/>
    </div>
</form>
</div>
