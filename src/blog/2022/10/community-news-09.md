...
As a thank you for reading our newsletters we’d like to offer you a free, small project for one month on FlowFuse when you create a new team. To get this discount please follow [this link]({% include "sign-up-url.njk" %}?code=RELEASE010) or use the code RELEASE010 when on the payment page after creating a new team.
