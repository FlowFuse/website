...
<video autoplay loop muted playsinline aria-label="Screenshot showing the message being sent from one project to another using project link nodes"><source src="./images/ProjectLink.webm" type="video/webm"></source></video>
