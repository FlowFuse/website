...
![1](./images/ethip-to-profinet/1.png)
...
![2](./images/ethip-to-profinet/2.png)

Each tag must also have external read/write access enabled.

![3](./images/ethip-to-profinet/3.png)
...
*   ![4](./images/ethip-to-profinet/4.png)
    
    “No protection” must be set in the CPU properties
    
*   ![5](./images/ethip-to-profinet/5.png)
...
![10](./images/ethip-to-profinet/10.png)
...
![11](./images/ethip-to-profinet/11.png)
...
![12](./images/ethip-to-profinet/12.png)
...
![13](./images/ethip-to-profinet/13.png)
...
![14](./images/ethip-to-profinet/14.png)

But just to confirm, let’s toggle the value and see if comes through.

![15](./images/ethip-to-profinet/15.png)
...
![18](./images/ethip-to-profinet/18.png)
...
![19](./images/ethip-to-profinet/19.png)
...
![23](./images/ethip-to-profinet/23.png)
...
![24](./images/ethip-to-profinet/24.png)
