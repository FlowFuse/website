...
<video autoplay loop muted playsinline aria-label="Catching an error from the Read File node and outputting a message to debug"><source src="./images/catch.webm" type="video/webm"></source></video>
