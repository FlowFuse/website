...
You can sign up for a [free FlowFuse Cloud Account]({% include "main-cta-url.njk" %}) where you'll be given one small Node-RED instance for free, for your first month.
