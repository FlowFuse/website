...
We've created the content you'll need for this file and shared it via [this GitHub page](https://github.com/FlowFuse/flowforge-device-agent/blob/main/service/flowforge-device.service).
