...
<video autoplay loop muted playsinline aria-label="Progress spinner, random values"><source src="./images/random-progress-element.webm" type="video/webm"></source></video>
