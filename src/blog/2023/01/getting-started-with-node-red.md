...
To get Node-RED running on FlowFuse [sign up as a new user]({% include "main-cta-url.njk" %}). New users are enrolled in a trial and a Node-RED instance will be started for you within a minute.
