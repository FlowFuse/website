...
<video autoplay loop muted playsinline aria-label="Capturing debug to a log file using Flogger"><source src="./images/flogger.webm" type="video/webm"></source></video>
