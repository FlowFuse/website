...
<video autoplay loop muted playsinline aria-label="Selecting a node without having to use the palette"><source src="/blog/2023/02/images/load-node.webm" type="video/webm"></source></video>
...
<video autoplay loop muted playsinline aria-label="Spliting your nodes with link nodes"><source src="/blog/2023/02/images/split-with-link.webm" type="video/webm"></source></video>
...
<video autoplay loop muted playsinline aria-label="Linking multiple inputs and outputs in one command"><source src="/blog/2023/02/images/join-wires.webm" type="video/webm"></source></video>
