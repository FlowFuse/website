...
<video autoplay loop muted playsinline aria-label="Selecting a node without having to use the palette"><source src="./images/load-node.webm" type="video/webm"></source></video>
...
<video autoplay loop muted playsinline aria-label="Spliting your nodes with link nodes"><source src="./images/split-with-link.webm" type="video/webm"></source></video>
...
<video autoplay loop muted playsinline aria-label="Linking multiple inputs and outputs in one command"><source src="./images/join-wires.webm" type="video/webm"></source></video>
