...
![Splitting an Array](/images/core-nodes/split-node-array.png)
...
![Regroup an Array with Split](/images/core-nodes/split-node-regroup.png)
...
![Splitting text by line](/images/core-nodes/split-node-by-line.png "Node-RED flow to split text by line")
...
![Node-RED split by word](/images/core-nodes/split-node-by-word.png "Split text by space in Node-RED")
...
![Split an object](/images/core-nodes/split-node-hash.png "Split arbitrary objects")
