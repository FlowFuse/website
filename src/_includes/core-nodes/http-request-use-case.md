...
1. Below is an example example showing how you can construct a URL with message properties in the HTTP request node, example includes sending GET request.
