...
<video autoplay loop muted playsinline aria-label="Copy Path helper" width="906" height="397" preload="none"><source src="/node-red/core-nodes/images/debug-copy-path.webm" type="video/webm" /></video>
...
<video autoplay loop muted playsinline aria-label="Copy Value helper" width="825" height="655" preload="none"><source src="/node-red/core-nodes/images/debug-copy-value.webm" type="video/webm" /></video>
...
<video autoplay loop muted playsinline aria-label="Pin Open helper" width="825" height="655" preload="none"><source src="/node-red/core-nodes/images/debug-pin-open.webm" type="video/webm" /></video>
