...
<video autoplay loop muted playsinline aria-label="List of nodes installed through the System Info dialog"><source src="./images/system-info-installed-nodes.webm" type="video/webm"></source></video>
