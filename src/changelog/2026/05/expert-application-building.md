...
As the Expert works, real-time tool-call status keeps you in the loop, so you can see what it is adding and why.

<!-- TODO: replace placeholder with a short screen recording of the Expert assembling, for example, an OEE dashboard on the canvas. Upload to YouTube via #dev-marketing and embed with <lite-youtube>. -->

![Placeholder for screen recording of FlowFuse Expert building an application on the canvas](./images/expert-application-building.png){data-zoomable}
