...
- Wherever possible use:
  ...
  - The NJK shortcode in website body: `{% image "./relative-path-to-image.png", "Image alt tag for screen readers", [150] %}`
...
By default, each webpage on the FlowFuse website includes a set of predefined keywords (configured in `site.messaging.keywords`). These default keywords are relevant to the overall theme of the website and help categorize the content.
