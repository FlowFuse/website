...
[this report](https://main.flowforge.cloud/ui/#!/7?socketid=reLw4efoWf45RfOsAACH).
...
and can be
[accessed in this application](https://main.flowforge.cloud/).
...
| FFC-Actions | This shows actions which have been taken by someone on a team this contact is on. To see a full list of available actions view [this report](https://app-eu1.hubspot.com/reports-list/26586079/182831966/) in Hubspot |                                                                                                                               |
| FFC-Usage | This field shows a contact's answer to how they are planning to use FlowFuse Cloud, you can view the options and current data on [this report](https://app-eu1.hubspot.com/reports-list/26586079/182851924/).|
